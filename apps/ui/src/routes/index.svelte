...
<nav class="header flex-wrap gap-2">
	<h1 class="mr-4 text-2xl font-bold">{$t('index.dashboard')}</h1>
	{#if $appSession.isAdmin && (applications.length !== 0 || destinations.length !== 0 || databases.length !== 0 || services.length !== 0 || gitSources.length !== 0)}
		<NewResource />
	{/if}
	<div class="flex-1" />
	{#if filtered.otherApplications.length > 0 || filtered.otherServices.length > 0 || filtered.otherDatabases.length > 0 || filtered.otherGitSources.length > 0 || filtered.otherDestinations.length > 0}
		<button
			class="btn btn-sm"
			class:btn-primary={showOtherTeams}
			class:btn-outline={!showOtherTeams}
			on:click={() => (showOtherTeams = !showOtherTeams)}
		>
			<svg
			...
			{showOtherTeams ? 'Hide Other Teams' : 'Other Teams'}
		</button>
	{/if}
</nav>
<div class="container lg:mx-auto lg:p-0 px-4 lg:px-8 pt-5">
	{#if applications.length !== 0 || destinations.length !== 0 || databases.length !== 0 || services.length !== 0 || gitSources.length !== 0}
	...
	{#if !showOtherTeams && filtered.applications.length > 0 && applications.length > 0}
		<section style="margin-top: 2rem; border-radius: 0.75rem; border: 1px solid #282828; background-color: #000000; padding: 1rem;">
			...
			<div
				class="grid gap-4 lg:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-2 pt-6"
			>
				{#each filtered.applications as application}
					<a class="no-underline" href={`/applications/${application.id}`}>
						<div
							class="w-full h-full rounded p-5 bg-coolgray-200 hover:bg-green-600 indicator duration-150"
						>
		...
		<section style="margin-top: 2rem; border-radius: 0.75rem; border: 1px solid #282828; background-color: #000000; padding: 1rem;">
			...
			>
				{#each filtered.services as service}
					{#key service.id}
						<a class="no-underline" href={`/services/${service.id}`}>
							<div
								class="w-full h-full rounded p-5 bg-coolgray-200 hover:bg-pink-600 indicator duration-150"
							>
				...
				{#each filtered.databases as database}
					{#key database.id}
						<a class="no-underline" href={`/databases/${database.id}`}>
							<div
								class="w-full h-full rounded p-5 bg-coolgray-200 hover:bg-databases indicator duration-150"
							>
	...
	{#if showOtherTeams && (filtered.otherApplications.length > 0 || filtered.otherServices.length > 0 || filtered.otherDatabases.length > 0 || filtered.otherGitSources.length > 0 || filtered.otherDestinations.length > 0)}
		<section style="margin-top: 2rem; border-radius: 0.75rem; border: 1px solid #282828; background-color: #000000; padding: 1rem;">
			...
			{#if filtered.otherApplications.length > 0}
				<h2 class="text-xl font-bold pt-6 px-2">Applications</h2>
				<div
					class="grid gap-4 lg:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-2 pt-4"
				>
			...
			{#if filtered.otherServices.length > 0}
				<h2 class="text-xl font-bold pt-6 px-2">Services</h2>
				<div
					class="grid gap-4 lg:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-2 pt-4"
				>
			...
			{#if filtered.otherDatabases.length > 0}
				<h2 class="text-xl font-bold pt-6 px-2">Databases</h2>
				<div
					class="grid gap-4 lg:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-2 pt-4"
				>
			...
			{#if filtered.otherGitSources.length > 0}
				<h2 class="text-xl font-bold pt-6 px-2">Git Sources</h2>
				<div
					class="grid gap-4 lg:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-2 pt-4"
				>
					{#each filtered.otherGitSources as source}
						{#key source.id}
							<a class="no-underline" href={`/sources/${source.id}`}>
								<div
									class="w-full h-full rounded p-5 bg-coolgray-200 hover:bg-sources indicator duration-150"
								>
									<div class="w-full flex flex-row">
			...
			{#if filtered.otherDestinations.length > 0}
				<h2 class="text-xl font-bold pt-6 px-2">Destinations</h2>
				<div
					class="grid gap-4 lg:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-2 pt-4"
				>
					{#each filtered.otherDestinations as destination}
						{#key destination.id}
							<a class="no-underline" href={`/destinations/${destination.id}`}>
								<div
									class="w-full h-full rounded p-5 bg-coolgray-200 hover:bg-destinations indicator duration-150"
								>
									<div class="w-full flex flex-row">
	...
	{#if filtered.applications.length === 0 && filtered.databases.length === 0 && filtered.services.length === 0 && $search}
